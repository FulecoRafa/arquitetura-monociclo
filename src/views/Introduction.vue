<template>
    <TextCard>
        ...
        <Content>
            ...
            <br>Todos os processos complexos de um <Hyperlink to="https://pt.wikipedia.org/wiki/C%C3%B3digo-fonte">código fonte</Hyperlink> precisam ser quebrados em processos muito pequenos, mas bastante trabalhosos, para que juntos executem um processo complexo, que muitas vezes é tão simples quanto adicionar um elemento a uma lista <Hyperlink to="https://pt.wikipedia.org/wiki/Lista_ligada">encadeada</Hyperlink>. Esse, inclusive, requer dezenas de pequenas operações.
